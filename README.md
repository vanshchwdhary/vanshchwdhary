...
<!-- Dynamic Typing Text -->
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&duration=3000&pause=800&color=00E5FF&center=true&vCenter=true&width=600&lines=Welcome+to+my+Digital+Universe+🌌;Cybersecurity+Enthusiast+🔐;Full+Stack+Developer+💻;AI+%26+ML+Learner+🤖;Building+Cool+Things+on+the+Internet+🚀" />
</p>
...
> *"Turning ideas into code & code into reality."*
...
const vansh = {
  ...
  location: "India 🇮🇳",
  portfolio: "https://farmfixer.xyz",
  skills: ["React", "Node.js", "JavaScript", "Python", "Java", "C++"],
  interests: ["Cybersecurity", "Web Development", "Machine Learning"],
